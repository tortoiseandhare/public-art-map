...
Use **pnpm** for installs (`pnpm-lock.yaml` is committed). Do not commit `package-lock.json` (ignored); mixing npm + pnpm lockfiles can break deterministic installs on CI/Vercel.
